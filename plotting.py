...
class plotter:
    def __init__(self,simu_name):
        ...
        df_dvl = pd.read_csv("/home/maxwmr/Documents/work/simu_analysis_cpp/results/"+simu_name+'/DVL.txt',sep=';')
        df_imu = pd.read_csv("/home/maxwmr/Documents/work/simu_analysis_cpp/results/"+simu_name+'/IMU.txt',sep=';')
    
        self.imuaccel =  np.stack([df_imu['accx'].to_numpy(),df_imu['accy'].to_numpy(),df_imu['accz'].to_numpy()]).T
